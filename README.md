...
```
.github/
├── ISSUE_TEMPLATE/       # Default issue templates for all repositories
├── PULL_REQUEST_TEMPLATE/# Default PR templates
├── workflows/            # Reusable workflow templates
├── profile/              # Organization profile README
│   └── README.md         # Displayed on organization homepage
...
├── SUPPORT.md            # Default support information
...
- [About organization-wide community health files](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/creating-a-default-community-health-file)
- [Creating a profile README for your organization](https://docs.github.com/en/organizations/collaborating-with-groups-in-organizations/customizing-your-organizations-profile)
